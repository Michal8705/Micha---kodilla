...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://michal8705.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("Michal8705@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("mojehaslotrello");
